...
OPTIONS:
  ...
  --output-format <fmt>       Formato del informe: md (default), json, html
...
| `json` | JSON estructurado para programatic use o comparación |
...
| `output-format` | `md` | Formato del informe |
