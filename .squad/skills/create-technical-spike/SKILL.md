...
Time-boxed research for critical technical questions that must be answered before development. Each spike focuses on a single decision with clear deliverables and timelines.
...
- **No time box** — Research expands infinitely without constraints
